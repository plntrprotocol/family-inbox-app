...
export async function onRequestGet(context) {
  ...
  try {
    ...
    user = await stmt.bind(apiKey).first();
  } catch (e) {
    // DB not set up yet - return mock
    return new Response(JSON.stringify({ messages: [], note: 'DB not configured' }));
  }
